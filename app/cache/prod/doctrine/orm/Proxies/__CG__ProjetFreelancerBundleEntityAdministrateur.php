 ...
 */
class Administrateur extends \Projet\FreelancerBundle\Entity\Administrateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Projet\\FreelancerBundle\\Entity\\Administrateur' . "\0" . 'email', '' . "\0" . 'Projet\\FreelancerBundle\\Entity\\Administrateur' . "\0" . 'motdepasse', '' . "\0" . 'Projet\\FreelancerBundle\\Entity\\Administrateur' . "\0" . 'nom', '' . "\0" . 'Projet\\FreelancerBundle\\Entity\\Administrateur' . "\0" . 'prenom', '' . "\0" . 'Projet\\FreelancerBundle\\Entity\\Administrateur' . "\0" . 'role', '' . "\0" . 'Projet\\FreelancerBundle\\Entity\\Administrateur' . "\0" . 'id');
        }
