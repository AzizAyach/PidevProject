 ...
 */
class AsoTest extends \Projet\FreelancerBundle\Entity\AsoTest implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Projet\\FreelancerBundle\\Entity\\AsoTest' . "\0" . 'idAs', '' . "\0" . 'Projet\\FreelancerBundle\\Entity\\AsoTest' . "\0" . 'idTest', '' . "\0" . 'Projet\\FreelancerBundle\\Entity\\AsoTest' . "\0" . 'idQuest');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AsoTest $proxy) {
    ...
    public function getIdAs()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdAs();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdAs', array());

        return parent::getIdAs();
    }
    ...
    public function setIdQuest(\Projet\FreelancerBundle\Entity\Question $idQuest = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdQuest', array($idQuest));

        return parent::setIdQuest($idQuest);
    }
