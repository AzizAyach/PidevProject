...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\message-bundle\\FOS\\MessageBundle\\Resources\\config\\doctrine') => 'FOS\\MessageBundle\\Entity', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine') => 'FOS\\UserBundle\\Entity', ($this->targetDirs[3].'\\src\\Projet\\FreelancerBundle\\Resources\\config\\doctrine') => 'Projet\\FreelancerBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'FOS\\MessageBundle\\Entity');
        $b->addDriver($a, 'FOS\\UserBundle\\Entity');
        $b->addDriver($a, 'Projet\\FreelancerBundle\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Utilisateurs\\usersBundle\\Entity'))), 'Utilisateurs\\usersBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('FOSMessageBundle' => 'FOS\\MessageBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'ProjetFreelancerBundle' => 'Projet\\FreelancerBundle\\Entity', 'usersBundle' => 'Utilisateurs\\usersBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9a997165e64b8782edb0023bd6528ef514ee19e67011a83561d2b230260ce62f');
    ...
    {
        return $this->services['fos_message.message_manager'] = new \FOS\MessageBundle\EntityManager\MessageManager($this->get('doctrine.orm.default_entity_manager'), 'Utilisateurs\\usersBundle\\Entity\\Message', 'Utilisateurs\\usersBundle\\Entity\\MessageMetadata');
    }
    ...
    {
        return $this->services['fos_message.thread_manager'] = new \FOS\MessageBundle\EntityManager\ThreadManager($this->get('doctrine.orm.default_entity_manager'), 'Utilisateurs\\usersBundle\\Entity\\Thread', 'Utilisateurs\\usersBundle\\Entity\\ThreadMetadata', $this->get('fos_message.message_manager'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Utilisateurs\\usersBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Utilisateurs\\usersBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Utilisateurs\\usersBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.demo_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/login$'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.demo_secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'main', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5521f29cc2073', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\message-bundle\\FOS\\MessageBundle/Resources/translations\\FOSMessageBundle.ar.yml'), 'ar', 'FOSMessageBundle');
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\message-bundle\\FOS\\MessageBundle/Resources/translations\\FOSMessageBundle.fa.yml'), 'fa', 'FOSMessageBundle');
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\message-bundle\\FOS\\MessageBundle/Resources/translations\\FOSMessageBundle.it.yml'), 'it', 'FOSMessageBundle');
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\message-bundle\\FOS\\MessageBundle/Resources/translations\\FOSMessageBundle.sk.yml'), 'sk', 'FOSMessageBundle');
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\message-bundle\\FOS\\MessageBundle/Resources/translations\\validators.ar.yml'), 'ar', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\message-bundle\\FOS\\MessageBundle/Resources/translations\\validators.en.yml'), 'en', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\message-bundle\\FOS\\MessageBundle/Resources/translations\\validators.fr.yml'), 'fr', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\message-bundle\\FOS\\MessageBundle/Resources/translations\\validators.pl.yml'), 'pl', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\message-bundle\\FOS\\MessageBundle/Resources/translations\\validators.ru.yml'), 'ru', 'validators');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Utilisateurs\\usersBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Projet\\FreelancerBundle/Resources/views'), 'ProjetFreelancer');
        $instance->addPath(($this->targetDirs[3].'\\src\\Utilisateurs\\usersBundle/Resources/views'), 'users');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ProjetFreelancerBundle' => 'Projet\\FreelancerBundle\\ProjetFreelancerBundle',
                'usersBundle' => 'Utilisateurs\\usersBundle\\usersBundle',
            ...
            'fos_message.message_meta_class' => 'Utilisateurs\\usersBundle\\Entity\\MessageMetadata',
            'fos_message.thread_meta_class' => 'Utilisateurs\\usersBundle\\Entity\\ThreadMetadata',
            'fos_message.message_class' => 'Utilisateurs\\usersBundle\\Entity\\Message',
            'fos_message.thread_class' => 'Utilisateurs\\usersBundle\\Entity\\Thread',
            ...
            'fos_user.model.user.class' => 'Utilisateurs\\usersBundle\\Entity\\User',
